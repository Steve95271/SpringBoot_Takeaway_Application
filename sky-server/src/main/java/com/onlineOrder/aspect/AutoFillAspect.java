package com.onlineOrder.aspect;

import com.onlineOrder.annotation.AutoFill;
import com.onlineOrder.constant.AutoFillConstant;
...
public class AutoFillAspect {
    ...
    @Pointcut("execution(* com.onlineOrder.mapper.*.*(..)) && @annotation(com.onlineOrder.annotation.AutoFill)")
