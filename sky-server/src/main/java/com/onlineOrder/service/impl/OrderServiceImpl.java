...
import com.onlineOrder.context.BaseContext;
import com.onlineOrder.dto.*;
import com.onlineOrder.entity.*;
import com.onlineOrder.exception.AddressBookBusinessException;
import com.onlineOrder.exception.OrderBusinessException;
import com.onlineOrder.exception.ShoppingCartBusinessException;
import com.onlineOrder.mapper.*;
import com.onlineOrder.result.PageResult;
import com.onlineOrder.service.OrderService;
import com.onlineOrder.utils.WeChatPayUtil;
import com.onlineOrder.vo.OrderPaymentVO;
import com.onlineOrder.vo.OrderStatisticsVO;
import com.onlineOrder.vo.OrderSubmitVO;
import com.onlineOrder.vo.OrderVO;
import com.onlineOrder.websocket.WebSocketServer;
...
public class OrderServiceImpl implements OrderService {
     ...
     */
    @Override
    public PageResult pageQueryWithCondition(OrdersPageQueryDTO dto) {

        //分页查询
        PageHelper.startPage(dto.getPage(), dto.getPageSize());
        Page<Orders> pageQueryResult = orderMapper.pageQueryWithCondition(dto);

        List<OrderVO> orderVOList = getOrderVOList(pageQueryResult);


        return new PageResult(pageQueryResult.getTotal(), orderVOList);
